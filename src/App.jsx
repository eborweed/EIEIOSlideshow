...
const memories = [
  ...
  { image: '/images/2.jpeg', title: 'Our First Date (Mar-9)', description: 'I remember you hiding your silly email, that was when I started falling a little. You also stole their plushy. Shouldve known you are a kleptomaniac by then.' },
    ...
    { image: '/images/20.JPG', title: 'When I realised I was Falling in Love (Apr-12)', description: 'I mentioned this before but it was when I truly let myself let go of the "nothing serious" BS and just let myself fall as much as I could. You asleep on my shoulder on that bus ride, drooling felt like heaven.' },
